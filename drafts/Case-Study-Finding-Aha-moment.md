...
이건 아닌 거 같다... 내용을 다 바꾸든지... 그런데 NUX 빼고 아하 모먼트만 설명하겠다는 게 과욕인 듯...

## 이슈
- NUX 디자인을 마치고 해야 할까?
- 아니면 이번에 하고 NUX 디자인을 들어갈까?
...
## 아하 모먼트란?
먼저 아하 모먼트의 정의를 다시 한번 기억합시다. 아하 모먼트는 **신규 사용자가 상품의 효용 가치를 깨닫는 순간**입니다.

NUX의 목표는 바로 신규 사용자가 이 아하 모먼트!를 통해 우리 상품의 효용 가치를 깨달아서 우리 고객이 되게 만드는 것입니다.

자 이제 실제 케이스를 살펴 봅시다.

## Case 1
첫번째 케이스는 모빌리티, 즉 이동 서비스입니다. 대표적으로 Uber가 있죠. 한번 불러서 타 보면 바로 아하 모먼트!를 경험할 수 있습니다. 

Uber 앱을 열고 회원 가입을 하고 신용카드 정보를 입력한 다음, 가고자 하는 목적지를 입력하고 호출을 하면 차가 오고 도착해서 내리면서 기사의 서비스를 평가합니다. 그럼 '오, 대박!'이라는 말이 절로 나옵니다. 

최근에 제가 코칭을 했던 스타트업 중에 애견택시, 펫미업이라는 서비스가 있습니다. 반려 동물과 함께 이동해야 할 때 이용할 수 있는 서비스인데요,
여기도 한 번 타 보면 아하 모먼트!를 경험할 수 있겠죠? 택시 불러서 혹시 반려 동물과 타도 되는지 물어 봐야 하는 불편함, 택시로 이동시 케이지에 넣어야만 하는 불편함, 이동 중에 반려 동물이 배변을 할 때 벌어지는 난처함 등의 걱정 없이 편리하게 이동할 수 있습니다. 

펫미업 차량에는 시트나 바닥의 오염을 방지하는 전용 매트가 설치되어 있습니다.
...
## Case 4
요즘 SNS에는 인플루엔서들이 많습니다.

중국의 왕홍도 마찬가지고

이런 분들이 자신의 팔로워들에게 좋은 상품을 팔기 시작하면 어떻게 할까요? 메신저나 댓글로 주문을 받아서 무통장 입금 확인을 해야 하고 주문 관리를 해야 하고 배송도 해야 하고 배송 알림도 보내줘야 하고 고객 상담이나 AS까지 진행해야 합니다.

이런 불편을 한방에 해결해 주고자 탄생한 서비스가 바로 INPOCK입니다.

저도 처음에는 INPOCK이 대체 구체적으로 어떤 문제를 해결하는지 잘 이해가 안 갔는데 입금 확인에 대한 이야기를 듣고 가장 쉽게 이해가 갔습니다. 메신저로 주문을 받고 누군가 무통장 입금을 하게 되면 그 사람의 입금 내역을 확인하는 게 번거로울 수 밖에 없습니다. 이 이야기를 듣고 납득이 가더군요. '아하 모먼트'의 간접경험인거죠. 물론 저는 인플루엔서, 즉 타겟 고객이 아니기 때문에 제 의견 따위는 전혀 중요치 않습니다. ㅎㅎㅎ

대표님이 'INPOCK을 이용해서 주문 처리를 한 번만 해 보면 깨닫는다'라고 하셨으니 그만큼 강력한 aha moment라면 무료로 서비스를 사용하게 하고 주문 당 수수료를 떼는 비즈니스 모델을 생각해 볼 수 있겠죠? 그러면 고객 입장에서 도입을 훨씬 쉽게 할 수 있겠죠? 또는 데모를 통해서 인플루엔서가 직접 주문도 해보고 입금 확인 및 주문 처리 과정을 체험해 볼 수 있게 하는 방법도 생각해 볼 수 있습니다.
